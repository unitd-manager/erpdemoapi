...
(`translation_id`, `key_text`, `value`, `arb_value`, `chi_value`, `creation_date`, `modification_date`, `group_name`, `is_html_text`, `show_to_user`, `flag`) 
VALUES 
(NULL, 'mdTradingSalesInvoice.Invoice Code', 'Invoice Code', 'رمز الفاتورة', 'GoodsDelivery Invoice Code field', NULL, NULL, NULL, NULL, NULL, '0'),
(NULL, 'mdTradingSalesInvoice.Invoice Source', 'Invoice Source', 'مصدر الفاتورة', 'GoodsDelivery Invoice Source field', NULL, NULL, NULL, NULL, NULL, '0'),
(NULL, 'mdTradingSalesInvoice.Sales Order', 'Sales Order', 'طلب المبيعات', 'GoodsDelivery Sales Order field', NULL, NULL, NULL, NULL, NULL, '0'),
(NULL, 'mdTradingSalesInvoice.Company Name', 'Company Name', 'اسم الشركة', 'GoodsDelivery Company Name field', NULL, NULL, NULL, NULL, NULL, '0'),
(NULL, 'mdTradingSalesInvoice.Invoice Date', 'Invoice Date', 'تاريخ الفاتورة', 'GoodsDelivery Invoice Date field', NULL, NULL, NULL, NULL, NULL, '0'),
(NULL, 'mdTradingSalesInvoice.Invoice Due Date', 'Invoice Due Date', 'تاريخ استحقاق الفاتورة', 'GoodsDelivery Invoice Due Date field', NULL, NULL, NULL, NULL, NULL, '0'),
(NULL, 'mdTradingSalesInvoice.Invoice Amount', 'Invoice Amount', 'قيمة الفاتورة', 'GoodsDelivery Invoice Amount field', NULL, NULL, NULL, NULL, NULL, '0'),
(NULL, 'mdTradingSalesInvoice.Invoice Terms', 'Invoice Terms', 'شروط الفاتورة', 'GoodsDelivery Invoice Terms field', NULL, NULL, NULL, NULL, NULL, '0'),
(NULL, 'mdTradingSalesInvoice.Title', 'Title', 'عنوان', 'GoodsDelivery Title field', NULL, NULL, NULL, NULL, NULL, '0'),
(NULL, 'mdTradingSalesInvoice.Unit', 'Unit', 'وحدة', 'GoodsDelivery Unit field', NULL, NULL, NULL, NULL, NULL, '0'),
(NULL, 'mdTradingSalesInvoice.Unit Price', 'Unit Price', 'سعر الوحدة', 'GoodsDelivery Unit Price field', NULL, NULL, NULL, NULL, NULL, '0'),
(NULL, 'mdTradingSalesInvoice.Ordered Quantity', 'Ordered Quantity', 'الكمية المطلوبة', 'GoodsDelivery Ordered Quantity field', NULL, NULL, NULL, NULL, NULL, '0'),
(NULL, 'mdTradingSalesInvoice.Invoice Quantity', 'Invoice Quantity', 'كمية الفاتورة', 'GoodsDelivery Invoice Quantity field', NULL, NULL, NULL, NULL, NULL, '0'),
(NULL, 'mdTradingSalesInvoice.Total Cost', 'Total Cost', 'التكلفة الإجمالية', 'GoodsDelivery Total Cost field', NULL, NULL, NULL, NULL, NULL, '0'),
(NULL, 'mdTradingSalesInvoice.Updated By', 'Updated By', 'تم التحديث بواسطة', 'GoodsDelivery Updated By field', NULL, NULL, NULL, NULL, NULL, '0');


********************************(20/03/2024 Translation(Sales Return-inserts field))**************************************
INSERT INTO `translation` 
(`translation_id`, `key_text`, `value`, `arb_value`, `chi_value`, `creation_date`, `modification_date`, `group_name`, `is_html_text`, `show_to_user`, `flag`) 
VALUES 
